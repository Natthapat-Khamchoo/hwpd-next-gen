...
**ต้องเปิด Google Docs API ก่อนใช้เมนูออกเอกสารจับกุม** โปรเจกต์ Google Cloud ที่ออก
OAuth ให้ระบบนี้เปิดไว้แค่ Sheets กับ Drive ตอนนี้เมนูนั้นตอบ 502 พร้อมข้อความบอกวิธีแก้
เปิดที่ <https://console.cloud.google.com/apis/library/docs.googleapis.com> แล้วเลือก
โปรเจกต์เดียวกับที่สร้าง OAuth client ไว้ ไม่ต้องขอ consent ใหม่ เพราะ scope `drive`
ที่มีอยู่ครอบคลุม Docs API อยู่แล้ว
