...
TABLE_COLUMNS: Dict[str, List[str]] = {
    ...
    + [
        ...
        "ละติจูด",
        "ลองจิจูด",
        # ช่วงเวลาที่ด่านเปิดจริง ใช้ตัดสินว่าหมุดบนแผนที่ระดับประเทศเป็นด่านที่
        # "ตั้งอยู่" ณ ตอนนี้หรือเลิกไปแล้ว ต่อท้ายคอลัมน์เดิมเพื่อไม่ให้ตำแหน่ง
        # คอลัมน์ที่มีข้อมูลอยู่แล้วเลื่อน
        "เวลาเริ่มตั้งด่าน",
        "เวลาเลิกด่าน",
    ],
    ...
    + [
        ...
        "Permalink",
        "วันเวลาที่เผยแพร่",
        # FR-07/08 ชิ้นงาน PR ที่ประกอบตามเทมเพลตแล้วอัปขึ้น Drive
        #
        # แยกจาก Permalink ข้างบนโดยตั้งใจ Permalink คือที่อยู่ของโพสต์บนเพจ ส่วน
        # Share_Url คือไฟล์ข้อความที่ระบบสร้าง ทั้งสองอย่างมีอายุและเจ้าของคนละคน
        # เก็บ Share_File_ID ไว้ด้วยเพราะถอนสิทธิ์สาธารณะต้องอ้างด้วย id ไม่ใช่ลิงก์
        "เทมเพลตชิ้นงาน PR",
        "Share_File_ID",
        "Share_Url",
