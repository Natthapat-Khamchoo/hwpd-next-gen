...
def main() -> int:
    ...
    # นับเป็นคู่ (วันที่, กก.) ไม่ใช่จำนวนแถว หนึ่งคู่มีได้หลายแถว เขียนให้ชัดตรงนี้
    # เพราะเลขคู่ที่น้อยกว่าจำนวนแถวมาก ทำให้อ่านผ่าน ๆ แล้วนึกว่าข้อมูลหายไป
    print(
        f"ตรวจแล้ว: คู่ (วันที่, กก.) ที่ใช้งานครบ {len(keys_after)} คู่เท่าเดิม "
        f"จาก {len(alive_after)} แถวที่ยังใช้งาน"
    )
